function getHodReviewHTML({ token, actionUrl }) {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Leave / Outpass Request Review (HOD)</title>
...
<body>
<div class="container">
  <h1>Leave / Outpass Request Review (HOD)</h1>
...
<script>
  ...
  fetch("/bf1/review/hod?token=" + encodeURIComponent(token))
    .then(async res => {
